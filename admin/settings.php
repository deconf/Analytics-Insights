								...
								<td colspan="2" class="title">
									<div class="onoffswitch">
										<input type="checkbox" name="options[switch_profile]"
											value="1" class="onoffswitch-checkbox" id="switch_profile"
...
printf(__('find out more %s'), sprintf('<a
...
<div class="wrap">
                ...
                ?>
						<tr>
													<td colspan="2" class="info"><input
														...
														<?php echo ($options['ga_dash_network'])?'disabled="disabled"':''; ?> /><?php echo " ".__("use your own API Project credentials", 'ga-dash' );?>
							</td>
												</tr>						<?php
            }
                    ...
                    ?>
							<tr>
																		<td colspan="2" class="info"><input
																			...
																			id="ga_dash_userapi" value="1"
																			<?php checked( $options['ga_dash_userapi'], 1 ); ?>
																			onchange="this.form.submit()" /><?php echo " ".__("use your own API Project credentials", 'ga-dash' );?>
								</td>
																	</tr>							<?php
                }
                if ($options['ga_dash_userapi']) {
    ...
    public static function output_sidebar()
    {
        ...
        printf(__('Plugin documentation and support on %s', 'ga-dash'), '<a href="https://deconf.com/google-analytics-dashboard-wordpress/?utm_source=gadwp_config&utm_medium=link&utm_content=support&utm_campaign=gadwp">deconf.com</a>');
        ?></div>
																<br />
																<div class="gadash-title">
																	<a
																...
																<div class="gadash-desc"><?php
        printf(__('Your feedback and review are both important, %s!', 'ga-dash'), sprintf('<a href="http://wordpress.org/support/view/plugin-reviews/google-analytics-dashboard-for-wp#plugin-info">%s</a>', __('rate this plugin', 'ga-dash')));
        ?></div>
															</div>
														</div>
														<div class="postbox">
															...
															<div class="inside">
																...
																<div class="gadash-desc"><?php
        printf(__('%s by moving your website to HTTPS/SSL.', 'ga-dash'), sprintf('<a href="https://deconf.com/move-website-https-ssl/?utm_source=gadwp_config&utm_medium=link&utm_content=ssl&utm_campaign=gadwp">%s</a>', __('Improve search rankings', 'ga-dash')));
        ?></div>
																<br />
																<div class="gadash-title">
																	<a
																...
																<div class="gadash-desc"><?php
        printf(__('Other %s written by the same author', 'ga-dash'), sprintf('<a href="https://deconf.com/wordpress/?utm_source=gadwp_config&utm_medium=link&utm_content=plugins&utm_campaign=gadwp">%s</a>', __('WordPress Plugins', 'ga-dash')));
        ?></div>
															</div>
														</div>
														<div class="postbox">
															...
															<div class="inside">
																...
																<div class="gadash-desc"><?php
        printf(__('Speed up your website and plug into a whole %s', 'ga-dash'), sprintf('<a href="https://deconf.com/wordpress-cdn-speeds-up-your-site/?utm_source=gadwp_config&utm_medium=link&utm_content=maxcdn&utm_campaign=gadwp">%s</a>.', __('new level of site speed', 'ga-dash')));
        ?></div>
																<br />
																<div class="gadash-title">
																	<a
																...
																<div class="gadash-desc"><?php
        printf(__('%s service with users tracking at IP level.', 'ga-dash'), sprintf('<a href="https://deconf.com/clicky-web-analytics-review/?utm_source=gadwp_config&utm_medium=link&utm_content=clicky&utm_campaign=gadwp">%s</a>', __('Web Analytics', 'ga-dash')));
        ?></div>
															</div>
														</div>
													</div>
