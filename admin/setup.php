				...
				if ( GADWP_Tools::check_roles( $this->gadwp->config->options['ga_dash_access_back'] ) && $this->gadwp->config->options['dashboard_widget'] ) {
					...
					wp_localize_script( 'gadwp-backend-dashboard-reports', 'gadwpItemData', array(
						...
						'i18n' => array(
							...
							__( "Browsers", 'google-analytics-dashboard-for-wp' ), //16
							__( "Operating Systems", 'google-analytics-dashboard-for-wp' ),
							__( "Screen Resolutions", 'google-analytics-dashboard-for-wp' ),
							__( "Mobile Brands", 'google-analytics-dashboard-for-wp' ),
