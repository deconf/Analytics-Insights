...
final class AIWP_Frontend_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo "\n<!-- BEGIN AIWP v" . AIWP_CURRENT_VERSION . " Widget - https://deconf.com/analytics-insights/ -->\n";
...
?>
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( "Title:",'analytics-insights' ); ?></label> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $widget_title ); ?>">
</p>
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'display' ) ); ?>"><?php _e( "Display:",'analytics-insights' ); ?></label> <select id="<?php echo esc_attr( $this->get_field_id('display') ); ?>" class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'display' ) ); ?>">
...
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'anonim' ) ); ?>"><?php _e( "Anonymize stats:",'analytics-insights' ); ?></label> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'anonim' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'anonim' ) ); ?>" type="checkbox" <?php checked( $anonim, 1 ); ?> value="1">
</p>
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'period' ) ); ?>"><?php _e( "Stats for:",'analytics-insights' ); ?></label> <select id="<?php echo esc_attr( $this->get_field_id('period') ); ?>" class="widefat" name="<?php echo esc_attr( $this->get_field_name( 'period' ) ); ?>">
...
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'give_credits' ) ); ?>"><?php _e( "Give credits:",'analytics-insights' ); ?></label> <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'give_credits' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'give_credits' ) ); ?>" type="checkbox" <?php checked( $give_credits, 1 ); ?> value="1">
</p>
<?php
		/* @formatter:on */
	}
