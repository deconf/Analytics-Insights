...
final class AIWP_Frontend_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo "\n<!-- BEGIN Analytics Insights v" . AIWP_CURRENT_VERSION . " Widget - https://deconf.com/analytics-insights-google-analytics-dashboard-wordpress/ -->\n";
