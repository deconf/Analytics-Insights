...
class GADWPAPI_Config
{
  ...
  /**
   * Create a new GADWPAPI_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'GADWPAPI_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'GADWPAPI_Cache_File',
      'logger_class'  => 'GADWPAPI_Logger_Null',
      ...
      'classes' => array(
        'GADWPAPI_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'GADWPAPI_IO_Curl' => array(
          'disable_proxy_workaround' => false,
          'options' => null,
        ),
        'GADWPAPI_Logger_Abstract' => array(
          'level' => 'debug',
          'log_format' => "[%datetime%] %level%: %message% %context%\n",
          'date_format' => 'd/M/Y:H:i:s O',
          'allow_newlines' => true
        ),
        'GADWPAPI_Logger_File' => array(
          'file' => 'php://stdout',
          'mode' => 0640,
          'lock' => false,
        ),
        'GADWPAPI_Http_Request' => array(
        ...
        'GADWPAPI_Service_Exception' => array(
          'retry_map' => array(
        ...
        'GADWPAPI_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/GADWPAPI_Client'
        )
      ),
    );
   ...
   * the hd values within an id token (@see GADWPAPI_Auth_LoginTicket) after sign
