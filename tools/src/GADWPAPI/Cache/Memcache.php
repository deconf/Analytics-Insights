 ...
 */
class GADWPAPI_Cache_Memcache extends GADWPAPI_Cache_Abstract
{
  ...
  public function __construct(GADWPAPI_Client $client)
  {
    if (!function_exists('memcache_connect') && !class_exists("Memcached")) {
      ...
      throw new GADWPAPI_Cache_Exception($error);
    }
   ...
   * @param string $key
   * @param string $value
   * @throws GADWPAPI_Cache_Exception
   */
  public function set($key, $value)
  {
    ...
    if ($rc == false) {
      ...
      throw new GADWPAPI_Cache_Exception("Couldn't store data in cache");
    }
