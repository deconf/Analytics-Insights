 ...
 * with the `GADWPAPI_Logger_Psr::setLogger()` method.
 */
class GADWPAPI_Logger_Psr extends GADWPAPI_Logger_Abstract
{
  /**
   ...
   */
  public function __construct(GADWPAPI_Client $client, /*Psr\Log\LoggerInterface*/ $logger = null)
  {
