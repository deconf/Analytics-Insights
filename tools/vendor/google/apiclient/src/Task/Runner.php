...
use Deconf\AIWP\Google\Task\Exception as GoogleTaskException;
...
class Runner
{
     ...
     * @throws \Deconf\AIWP\Google\Task\Exception when misconfigured
     */
     ...
     *
     * @return mixed
     * @throws \Deconf\AIWP\Google\Service\Exception on failure when no retries are available.
     */
    public function run()
    {
        while ($this->attempt()) {
