...
use Deconf\AIWP\Firebase\JWT\JWT;
...
class OAuth2 implements FetchAuthTokenInterface
{
     ...
     * @throws \Deconf\AIWP\Firebase\JWT\SignatureInvalidException If the signature is invalid.
     * @throws \Deconf\AIWP\Firebase\JWT\BeforeValidException If the token is not yet valid.
     * @throws \Deconf\AIWP\Firebase\JWT\ExpiredException If the token has expired.
     * @return null|object
     */
