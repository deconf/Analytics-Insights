...
class Normalizer
{
    const FORM_D = \Deconf_AIWP_Normalizer::FORM_D;
    const FORM_KD = \Deconf_AIWP_Normalizer::FORM_KD;
    const FORM_C = \Deconf_AIWP_Normalizer::FORM_C;
    const FORM_KC = \Deconf_AIWP_Normalizer::FORM_KC;
    const NFD = \Deconf_AIWP_Normalizer::NFD;
    const NFKD = \Deconf_AIWP_Normalizer::NFKD;
    const NFC = \Deconf_AIWP_Normalizer::NFC;
    const NFKC = \Deconf_AIWP_Normalizer::NFKC;
