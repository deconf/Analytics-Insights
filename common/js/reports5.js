	...
	aiwpItemReport : function ( itemId ) {
		...
		template = {
			...
			init : function () {
				...
				tpl += ' <a href="https://deconf.com/analytics-insights/?utm_source=aiwp_report&utm_medium=link&utm_content=back_report&utm_campaign=aiwp" rel="nofollow" style="text-decoration:none;font-size:1em;">Analytics Insights</a>&nbsp;';
				tpl += '</div>';
				tpl += '</div>',
